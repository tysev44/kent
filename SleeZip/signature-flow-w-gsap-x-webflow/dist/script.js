...
import MorphSVGPlugin from 'https://cdn.skypack.dev/gsap@3.13.0/MorphSVGPlugin';
...
// ORIGINAL REPLAY BUT COULD NOT WORK OUT HOW TO REVERSE THE PATH BUILDING
// let all
// let signoff
// some kind of reversal but the GSAP timeline doesn't reverse as expected
...
//       },
//     })
//     // work out number of points rendered....
//     // const count = [
//     //   ...animatedPath.getAttribute('d').matchAll(/[MLCQZ]\s*([^MLCQZ]*)/gi),
//     // ]
//     //   .flatMap((m) => m[1].trim().split(/\s+/))
//     //   .filter((_, i) => i % 2 === 0).length // count x-y pairs
//   }
// }
// const replaySignature = async () => {
